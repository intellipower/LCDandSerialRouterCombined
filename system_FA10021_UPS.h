...
#define DESCRIPTION "FA10021 6KVA Router "	// UCLASS, 240Vout, 4.2KW
...
#define SNMP_NOM_INPUT_TRANSFER ",192,280"
#define SNMP_NOM_LOW_BAT_TIME ",2"

// Debug

// This will monitor communication on active ports and output it to port indicated
//#define COMM_MONITOR_PORT (UPSNET_PORT)

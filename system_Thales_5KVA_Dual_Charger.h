...
//
// Version 1.08
//		Added then commented out CHARGER_MONSTER #define, see notes
// Version 1.07
//		Set UPS_STATE_CONTROL TRUE, commented out #define SNMP2
// Version 1.06
...
#define COM_SNMP
//#define COM_UPSILON
//#define SNMP2			// When Thales charger uses RS485 for SNMP parser to UPS,
						//  second SNMP uses normal SNMP port for local test interface.
#define RS485LOCKOUT	// FLAG to lock out the RS485 communications for UPS <=> Charger comm

// Communication Setup 4800, 9600
#define BAUD_UPS1		4800	// Port 0
#define BAUD_SNMP		9600	// Port 1
#define BAUD_UPSNET		9600	// Port 2
#define BAUD_UPS2		4800	// Port 3

// Communication port selection
typedef enum {
	UPS1_PORT = 0,		// Port 0
	SNMP2_PORT = 1,		// Second SNMP if active will use the "normal" SNMP port
	SNMP_PORT = 2,		// Port 1 Use RS485 connected to UPS Router interrogating with SNMP protocol

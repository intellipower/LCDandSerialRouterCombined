...
#define DESCRIPTION "Thales 3KVA Router "
...
// 12V * 82AH * 60^2 (sec in hour) * 9 batteries
//#define BAT_MAX_JOULE	((long) 31881600)	// initial estimation
#define BAT_MAX_JOULE	((long) 20495310)	// adjustment
